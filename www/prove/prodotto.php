...
<?php
  foreach ($recensioni as $recensione) {
    ...
    $rating_pers = ottieni_rating_personale();
    if ($rating_pers !== null) {
      $rated = true;
    }
    $rs = [];
    ...
    if ($rating_pers != null) {
      for ($i = 0; $i < 5; $i++) {
        $rs[$i] = $i < $rating_pers['supporto'] ? '\u2605' : '\u2606';
      }
      for ($i = 0; $i < 3; $i++) {
        $ru[$i] = $i < $rating_pers['utilita'] ? '\u2605' : '\u2606';
      }
    }
?>
          ...
          <div class="fb-20">
            ...
            <div class="riquadro pa-8 mt-8 mr-32">
              <p id="supporto_<?php echo($id_recensione); ?>">Supporto:
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'supporto', 1)"><?php echo($rs[0]); ?></a>
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'supporto', 2)"><?php echo($rs[1]); ?></a>
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'supporto', 3)"><?php echo($rs[2]); ?></a>
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'supporto', 4)"><?php echo($rs[3]); ?></a>
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'supporto', 5)"><?php echo($rs[4]); ?></a>
              </p>
              ...
              <p id="utilita_<?php echo($id_recensione); ?>">Utilit&agrave;:
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'utilita', 1)"><?php echo($ru[0]); ?></a>
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'utilita', 2)"><?php echo($ru[1]); ?></a>
                <a class="stellina" href="#" onclick="setCampo('rating', <?php echo($id_recensione); ?>, 'utilita', 3)"><?php echo($ru[2]); ?></a>
              </p>
            </div>
          </div>
          <div class="fb-80">
